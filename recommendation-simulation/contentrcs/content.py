...
from contentrcs.recommendation import get_recommendation
import pandas as pd
from contentrcs.learn import learn
...
with tab1:
    ...
    with left_col:
        ...
        # Action Button
        generate_btn = st.button("Generate Similar Movies",width="stretch")
